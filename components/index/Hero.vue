<template>
  <div >
    <v-img align="start">
      <v-row no-gutters>
        <v-col cols="12" align="center" v-if="events.length!=0">
            <v-img :src="image" height="450"  gradient="to top right, rgba(0,0,0,.38), rgba(0,0,0,0.38)">
