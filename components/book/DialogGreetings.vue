<template>
   <v-dialog v-model="isOpen" width="500" persistent>
    <v-card class="pa-10">
    <div align="center" class="text-h6">Successfully Reserved</div>
    <div align="center" class="pa-10">
      Would you like to proceed on status page?
    </div>
      <v-card-actions>
        <v-row align="center">
            <v-col align="end">
            ...
            <v-col>
                <v-btn color="success" :loading="buttonLoad" text @click="proceed"> Proceed </v-btn>
            </v-col>
        </v-row>
      </v-card-actions>
    </v-card>
