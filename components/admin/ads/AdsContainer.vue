<template>
  <v-card elevation="5">
    ...
    <ads-add   :isOpen="dialogAdd" @cancel="dialogAdd=false" @refresh="loadData" :items="selectedItem" :isAdd="isAdd"/>
    <v-row>
      ...
      <v-col align-self="center" align="end" class="pr-10">
        ...
        >
          <span class="text-none">Add Ad Ons</span>
        </v-btn>
      </v-col>
    </v-row>
    <v-data-table
